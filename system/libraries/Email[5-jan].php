...
class CI_Email {
	...
	var	$protocol		= "ses"; //"smtp";		// mail/sendmail/smtp
	...
	var	$smtp_user		= "AKIAJPFY23ZF2HCFSIRQ";							// SMTP Username
	var	$smtp_pass		= "3+t3WHsImYgBq5syNx+1GWL/toRE1sI+q2QCaVbp";		// SMTP Password
