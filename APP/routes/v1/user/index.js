...
//                                        console.log(Twilioresult);
     ...
     * @apiHeader {String} Content-Type application/json.
     * @apiHeader {integer} language 1=> English, 2 => Chinese , 3 => Korean
     * @apiDescription http://203.123.36.134:7777/api/v1/customer/verifyOtp/
     * @apiGroup Customer
     * @apiName verifyOtp
     * ***************************************************************************************************************************************************************
     * @apiParam (Expected parameters) {String}      customer_id            customer_id string
     * @apiParam (Expected parameters) {String}    country_code            country_code string
...
/***************************************************************************************************************************************************************/
     ...
     * @apiHeader {String} Content-Type application/json.
     * @apiHeader {integer} language 1=> English, 2 => Chinese , 3 => Korean
     * @apiDescription http://203.123.36.134:7777/api/v1/customer/verifyPhone/
     * @apiGroup Customer
     * @apiName verifyPhone
     * ***************************************************************************************************************************************************************
...
//                            console.log(Twilioresult);
     ...
     * @apiParam (Expected parameters) {Number}      phone_number             1234567890      
...
//            },
     ...
     * ***************************************************************************************************************************************************************
     ...
     "success": true,
     "status": 200,
     "message": "Your home page listing.",
     "api_version": "1.0.0",
     "data": {}
     }
     * @apiVersion 1.0.0
