...
<body>
    <header>
        ...
        <div class="profile-dropdown">
            <ul>
                <li>
                    <a data-attribute="forgo-pass" id="chnagepass" data-href="#"><i class="icon-lock"></i>Change password</a>
                </li>
                <li>
                    <a href="<?php echo base_url() ?>webLogout"><i class="icon-icon2"></i>Log Out</a>
                </li>
            </ul>
        </div>
    </header>
