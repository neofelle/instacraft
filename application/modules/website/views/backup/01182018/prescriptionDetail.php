...
<!--                <div class="btn-bg-grad">
                ...
                <div class="info-box note-u">
                    ...
                    <iframe src="<?php echo $client['prescription_front_image']; ?>" style="width:900px; height:1900px;" frameborder="0"></iframe>
                <embed src="pdfFiles/interfaces.pdf" width="600" height="500" alt="pdf" pluginspage="<?php echo $client['prescriptions']; ?>">
