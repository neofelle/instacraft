...
<!--                                    <img id="myImg" src="http://www.lifeline.ae/lifeline-hospital/wp-content/uploads/2015/02/LLH-Doctors-Male-Avatar.png" alt="Trolltunga, Norway"  width="138px">-->
                                    <img id="profileimage" style="border: 1px solid cyan;" width="152px" src="<?php echo $productinfo['itemsrc'] ? $productinfo['itemsrc'] : 'http://www.lifeline.ae/lifeline-hospital/wp-content/uploads/2015/02/LLH-Doctors-Male-Avatar.png'; ?> " alt="Profile Photo" />
                                                ...
                                                <?php
                                                 ...
                                                 if (count($warehouses) > 0) {
                                                    foreach ($warehouses as $key => $list) {
                                                        ...
                                                        $whT    = new DateTime($list['wharehouse_created_at']);
                                                ?>      
